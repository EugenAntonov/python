# -*- coding: utf-8 -*-
"""
Created on Sun Feb 13 15:01:36 2022
...
class Matix:
    ...
    def __str__(self):
        self.a = [",".join([str(i) for i in j]) for j in self.matrix]
        self.b = "\n".join(self.a)
        return self.b
...
a = [[11,12,103],[22,23,24],[5,7,5]]
b = [[21,22,23],[31,32,33],[5,5,1]]
...
class Cell:
    ...
    def __add__(self, other):
        new_cell_number = self.cell_number + other.cell_number        
        return Cell(new_cell_number)
    ...
    def make_order(self, cell_number_row):        
        return ("*" * cell_number_row + "\n")*(self.cell_number//cell_number_row) + "*" * (self.cell_number%cell_number_row)


a = Cell(10)
b = Cell(3)
c = a + b
print("a + b: ", c.cell_number)
